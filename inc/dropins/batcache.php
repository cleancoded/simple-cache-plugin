...
if ( empty( $batcache ) && ! empty( $GLOBALS['Cleancoded_config'] ) && isset( $GLOBALS['Cleancoded_config']['page_cache_length'] ) ) {
	$max_age = $GLOBALS['Cleancoded_config']['page_cache_length'] * 60;
...
if ( ! empty( $GLOBALS['Cleancoded_config']['cache_exception_urls'] ) ) {
