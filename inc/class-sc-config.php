...
class Cleancoded_Config {
	...
	public function write( $config, $force_network = false ) {
		...
		$config_dir = Cleancoded_get_config_dir();
	...
	public function get() {
		if ( Cleancoded_IS_NETWORK ) {
			$config = get_site_option( 'Cleancoded_simple_cache', $this->get_defaults() );
		} else {
			$config = get_option( 'Cleancoded_simple_cache', $this->get_defaults() );
		}
	...
	public function clean_up() {
		...
		if ( Cleancoded_IS_NETWORK ) {
			delete_site_option( 'Cleancoded_simple_cache' );
		} else {
			delete_option( 'Cleancoded_simple_cache' );
		}
